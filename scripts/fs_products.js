...
const fs_product_4 = {
    ...
    desc1: " ",
    img1: "https://images.samsung.com/ph/smartphones/galaxy-z-flip4/buy/Flip4_Carousel_ProductKV_BoraPurpfs_MO.jpg",
    img2: "https://www.xtmobile.vn/vnt_upload/product/08_2022/thumbs/(600x600)_crop_samsung-galaxy-z-flip-4-8gb-128gb.jpg",
    price: "$" + 1
}


const fs_products = [fs_product_0, fs_product_1, fs_product_2, fs_product_3, fs_product_4]
